...
@Component({
  ...
  standalone: true,
  imports: [IonNote, IonLabel, IonItem, IonAccordion, IonAccordionGroup, IonBackButton, IonIcon, IonButtons, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
